...
1. For chunks that return messaging or error messaging, create a separate test chunk.
...
1. For arguments that accept functions, check the tidyverse shortcut notation work as well as typical functions, e.g. `pvalue_fun = ~style_pvalue(.x)`
