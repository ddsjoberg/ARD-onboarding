...
1. Be sure to review the unit tests found in the `_archive/tests` folder. These tests are unfortunately poorly organized. Please read these tests to understand the intention behind them, and ensure we include similar testing in the update: we don't want to accidentally introduce regressions in package functionality.
